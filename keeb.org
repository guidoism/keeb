...
key = lambda k: 'D(KC.Q)' if k[0] == '⍉' else conversion[k]
...
KC.MO(3), KC.ESC, KC.LOPT, KC.LCMD, KC.MO(1), KC.SPC, KC.SPC, KC.MO(2), KC.NO, KC.NO, D(KC.Q), KC.NO,
],
[
# Layer 1
...
KC.NO, KC.NO, KC.NO, KC.NO, KC.MO(4), KC.NO, KC.NO, KC.NO, KC.NO, KC.NO, KC.NO, KC.NO,
],
[
# Layer 4

...
D(KC.MO(3)), KC.NO, KC.LOPT, KC.LCMD, KC.MO(1), KC.MO(3), KC.SPC, KC.MO(2), KC.NO, KC.NO, KC.NO, KC.NO,
],
[
# Layer 1
...
[
# Layer 3
KC.ESC, KC.NO, KC.NO, KC.NO, KC.NO, KC.NO, KC.NO, KC.PGUP, KC.UP, KC.PGDN, KC.NO, KC.NO,
...
def colon_pressed(key, keyboard, KC, *args, **kwargs):
    ...
    if TRIGGERS.intersection(keyboard.keys_pressed):
        # GUIDO: Use keyboard.add_key and keyboard.remove_key
        
        #key.has_modifiers.remove(KC.LSHIFT)
        #key.has_modifiers.remove(KC.RSHIFT)
        keyboard.keys_pressed.discard(KC.LSHIFT)
        keyboard.keys_pressed.discard(KC.RSHIFT)
